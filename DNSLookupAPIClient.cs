...
namespace APIVerve
{
    public class DNSLookupAPIClient
    {
        ...
        public DNSLookupAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public DNSLookupAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(dnslookupQueryOptions options)
        {
            try
            {
                if (_isDebug)
